 ...
 * ```
 */
export declare class DbAction<TRead = unknown, TWrite = unknown> {
    /**
     ...
     */
    private readonly databaseInstance;
    /**
     ...
     * @throws {TypeError}
     */
    constructor(action: DatabaseActionType, databaseInstance: IDBDatabase, storeName: string);
    /**
